...
try {
    ...
    inspect = function (obj) { console.log(util.inspect(obj).white); };
}
...
this.Console.prototype = new(function () {
    ...
    this.welcome = function () {
        console.log([
          "> " + ("http-console " + exports.version).bold,
    ...
    this.request = function (method, path, headers, callback) {
        ...
        this.headers.host =
          this.headers.host ||
          this.host + (this.port === 80 ? '' : ':' + this.port.toString());
        ...
        if (this.options.verbose) {
            ...
            Object.keys(headers).forEach(function (name) {
                console.log((name + ': ' + headers[name]).grey);
            });
            console.log('');
        }
